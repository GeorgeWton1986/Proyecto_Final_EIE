...
cat("✓ Tabla guardada en tablas/study_event_table.png\n")
...
etable(modelo_imp_m1,
       ...
       drop = "cobertura|poblacion|SGP|^ym_2$|^departamento$",
       notes = c("Notas: Estación de ponderacion por Varianza inversa",
