...
ggplot(datos_pesos, aes(x = Variable, y = Peso, fill = Variable)) +
  geom_col(alpha = 0.7) +
  labs(title = "Ponderaciones del IVIG (Varianza Inversa)",
       x = "",
       y = "Peso") +
  theme_minimal() +
...
p3_imp <- plot_tendencias(BD_0, "grupo_IVIG_3_label",
                          "Productividad Industrial Nominal - Importación GNI",
