...
writeLines(doc_completo, "Tablas/study_event_table.tex")
...
if (inherits(resultado, "try-error")) {
  ...
  if (file.exists("study_event_table.log")) {
    log_lines <- readLines("study_event_table.log")
...
# Convertir a PNG
if (file.exists("Tablas/study_event_table.pdf")) {
  img <- image_read_pdf("Tablas/study_event_table.pdf", density = 300)
  image_write(img, "Tablas/study_event_table.png")
  cat("✓ Tabla convertida a PNG: Tablas/study_event_table.png\n")
  
  # Limpiar archivos temporales
  archivos_temp <- c("Tablas/tabla_temp.tex",
                     "Tablas/study_event_table.pdf",
                     "Tablas/study_event_table.aux", 
                     "Tablas/study_event_table.log")
...
# Guardar UN SOLO archivo .tex
writeLines(doc_completo, "Tablas/heterogeneidad_industria.tex")
cat("✓ Archivo .tex guardado\n")
...
resultado <- try({
  tinytex::pdflatex("heterogeneidad_industria.tex")
}, silent = FALSE)

if (inherits(resultado, "try-error")) {
  cat("\n❌ Error al compilar. Mostrando las últimas líneas del log:\n\n")
  if (file.exists("heterogeneidad_industria.log")) {
    log_lines <- readLines("heterogeneidad_industria.log")
    cat(tail(log_lines, 30), sep = "\n")
  }
  setwd(dir_actual)
  stop("No se pudo compilar el documento LaTeX")
...
# Convertir a PNG
if (file.exists("Tablas/heterogeneidad_industria.pdf")) {
  img <- image_read_pdf("Tablas/heterogeneidad_industria.pdf", density = 300)
  image_write(img, "Tablas/heterogeneidad_industria.png")
  cat("✓ Tabla convertida a PNG: Tablas/heterogeneidad_industria.png\n")
  
  # Limpiar archivos temporales
  archivos_temp <- c("Tablas/tabla_temp.tex",
                     "Tablas/heterogeneidad_industria.pdf",
                     "Tablas/heterogeneidad_industria.aux", 
                     "Tablas/heterogeneidad_industria.log")
  file.remove(archivos_temp[file.exists(archivos_temp)])
  cat("✓ Archivos temporales eliminados\n")
} else {
  cat("❌ No se generó el PDF\n")
...
# Guardar UN SOLO archivo .tex
writeLines(doc_completo, "Tablas/heterogeneidad_vulnera.tex")
cat("✓ Archivo .tex guardado\n")
...
resultado <- try({
  tinytex::pdflatex("heterogeneidad_vulnera.tex")
}, silent = FALSE)

if (inherits(resultado, "try-error")) {
  cat("\n❌ Error al compilar. Mostrando las últimas líneas del log:\n\n")
  if (file.exists("heterogeneidad_vulnera.log")) {
    log_lines <- readLines("heterogeneidad_vulnera.log")
    cat(tail(log_lines, 30), sep = "\n")
  }
  setwd(dir_actual)
  stop("No se pudo compilar el documento LaTeX")
...
# Convertir a PNG
if (file.exists("Tablas/heterogeneidad_vulnera.pdf")) {
  img <- image_read_pdf("Tablas/heterogeneidad_vulnera.pdf", density = 300)
  image_write(img, "Tablas/heterogeneidad_vulnera.png")
  cat("✓ Tabla convertida a PNG: Tablas/heterogeneidad_vulnera.png\n")
  
  # Limpiar archivos temporales
  archivos_temp <- c("Tablas/tabla_temp.tex",
                     "Tablas/heterogeneidad_vulnera.pdf",
                     "Tablas/heterogeneidad_vulnera.aux", 
                     "Tablas/heterogeneidad_vulnera.log")
  file.remove(archivos_temp[file.exists(archivos_temp)])
  cat("✓ Archivos temporales eliminados\n")
} else {
  cat("❌ No se generó el PDF\n")
