...
BD_0 <- BD_0 %>%
  mutate(
    grupo_IVIG_1 = ifelse(IVIG_1_dt == 1, "Tratado", "Control"),
    grupo_IVIG_2 = ifelse(IVIG_2_dt == 1, "Tratado", "Control"),
    grupo_IVIG_3 = ifelse(IVIG_3_dt == 1, "Tratado", "Control")
  )

```

### Tendencias paraledas

```{r}
# Gráfico de tendencias paralelas para IVIG método 1
ggplot(BD_0, aes(x = periodo, y = productividad_industrial_nominal, color = grupo_IVIG_1)) +
  geom_line(stat = "summary", fun = "mean", size = 1) +
  geom_vline(xintercept = 2022, linetype = "dashed", color = "red") +
  labs(title = "Tendencias Paralelas de Productividad Industrial Nominal",
       x = "Periodo",
